    ...
    const products = [
        {
            ...
            images: ['/images/shop/items/s14.jpg'],
            sizes: ['38', '39', '40'],
            ...
            stock: 100,
            description:
                'Party season arrived just in time! The Lulus Lullie Black Suede Rhinestone Ankle Strap Pointed-Toe Pumps have a soft faux suede composition and a pointed-toe upper. Sparkly rhinestones adorn the wrapping adjustable ankle strap and topline, and form a dramatic bow detail on the toe box.',
        },
        {
